...
const AppNavigation = ({
  ...
  return (
    <>
      ...
      <div className={`mt-5 inline-flex p-1.5 ${APP_THEME.surface.panel}`}>
        <button
          type="button"
          className={`motion-icon motion-lift rounded-xl px-4 py-2.5 text-[15px] font-semibold ${
      ...
      <div className={`mt-3 inline-flex p-1.5 ${APP_THEME.surface.panel}`}>
        <button
          type="button"
          className={`motion-icon motion-lift rounded-xl px-4 py-2.5 text-[15px] font-semibold ${
